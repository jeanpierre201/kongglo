                ...
                {/*  Portada1 y Portada2 */}
                    ...
                    <div className="col-md">
                        <div className = "card border-0 rounded-0 mb-3" >
                            ...
                            <a href={"/news/detail/kongglonews?title=" + props.title[0] + "&image=" + props.image[0] + "&description=" + props.description[0] + "&link=" + props.link[0] + "&media=" + props.media + "&pubdate=" + props.pubdate[0]}>
                                <div className="card-img-overlay text-overlay-1-abc">
                    ...
                    <div className="col-md  ">
                        <div className = "card border-0 rounded-0" >
                            ...
                            <div className="card-img-overlay text-overlay-2-abc">
                                <div className="heading">
            ...
            <div className="row">
                ...
                <div className="col-md ">
                    <div className = "card border-0 rounded-0 mb-3" >
                        ...
                        <div className="card-img-overlay text-overlay-3-abc">
                            <div className="heading">
                ...
                <div className="col-md ">
                    <div className = "card border-0 rounded-0" >
                        ...
                        <div className="card-img-overlay text-overlay-4-abc">
                            <div className="heading">
